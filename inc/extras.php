  ...
  if ( is_front_page() && of_get_option( 'sparkling_slider_checkbox' ) == 1 ) {
    echo '<div class="flexslider">';
      echo '<ul class="slides">';
        ...
        $query = new WP_Query( array( 'cat' ,'posts_per_page' =>$count ) );
        if ($query->have_posts()) :
          ...
          echo '<li><a href="'. get_permalink() .'">';
            if ( (function_exists( 'has_post_thumbnail' )) && ( has_post_thumbnail() ) ) :
              ...
              echo '<div class="flex-caption"><div class="slider_category">';
                if ( the_category() != '' ) echo '<div class="excerpt">' . the_category() .'</div>';
                 echo '</div>';
                  if ( get_the_title() != '' ) echo '<h1 class="entry-title-slider">'. mb_strimwidth(get_the_title(), 0, 20).'</h1><div class="date_style">';
                  
                  
               echo '<div class="header_clock"><span class="header_clock_span"><i class="fa fa-clock-o" aria-hidden="true"></i></span>';
              the_time('d F, Y ');
             echo '</div>';    
              echo '<div class="header_author"><span class="header_author_span"><i class="fa fa-user" aria-hidden="true"></i></span>';
              the_author();
             echo '</div>';
//              echo '<span class="clock"><i class="fa fa-clock-o" aria-hidden="true"></i></span>'.the_time('d F, Y ');
//                  
              echo '</div></div>';
