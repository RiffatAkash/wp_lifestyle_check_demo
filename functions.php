...
function sparkling_widgets_init() {
  ...
  register_sidebar(array(
   ...
   register_sidebar(array(
         'name'=>__('MY_SIDE_BAR','sparkling'),
         'description'=>__('Add your sidebar widgets here','sparkling'),
         'id'=>'MY_SIDE_BAR',
         'before_widget'=>'<div id="%1$s" class="widget %2$s"><div class="col-md-3 ">',
  ...
  register_widget( 'sparkling_recent_posts_for_sidebar' );
  register_widget( 'sparkling_popular_posts_for_footer' );

}
add_action( 'widgets_init', 'sparkling_widgets_init' );

add_image_size('slid',1024,460,true);
/* --------------------------------------------------------------
       Theme Widgets
-------------------------------------------------------------- */
...
require_once(get_template_directory() . '/inc/widgets/widget-popular-posts-footer.php');
require_once(get_template_directory() . '/inc/widgets/widget-recent-posts.php');
require_once(get_template_directory() . '/inc/widgets/widget-recent-posts-for-sidebar.php');
require_once(get_template_directory() . '/inc/widgets/widget-contact.php');
